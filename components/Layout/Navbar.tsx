        ...
        <ul className="list-none hidden lg:flex h-full gap-x-5 items-center">
          {navLinkArr.map(({ name, href }, index) => (
            <div key={index} className="">
              <li className="relative py-2 font-medium xl:text-2xl 2xl:text-3xl before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-0 before:h-1 before:bg-slate-200 before:transition-width before:ease-in-out before:duration-500 hover:before:w-full">
